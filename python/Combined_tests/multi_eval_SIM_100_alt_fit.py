...
logo_temp_100 = cv.imread('/home/gaetan/code/simulation_ws/src/my_simulations/models/psi_logo/materials/textures/poster-psi-drone-logo-10percent.png',0)

# load the camera parameters stored in episode 1
f = h5py.File('/home/gaetan/data/hdf5/psi_800res_alt_rot_concrete_fine/data4_sync.hdf5', 'r+')
...
def dump(output_dir,hdf5_data,ep):
        ...
        output_hdf5_path = output_dir + '/psi_800res_alt_rot_100_rec_fit_8repr_concrete_fine' + '.hdf5'
        ...
        hdf5_file.close()
dump(current_dir,hdf5_data,'psi_800res_alt_rot_100_rec_fit_8repr_concrete_fine')