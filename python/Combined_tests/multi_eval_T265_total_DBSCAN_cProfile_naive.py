...
def pose_est(kp_temp_orb_1, des_temp_orb_1,kp_temp_orb_2, des_temp_orb_2,
    ...
    if rel_pos_c[2] < 3.0:
            ...
            est_orb_1,inl = det.detect_match(K,kp_temp_orb_1,des_temp_orb_1,logo_temp_1_shape,orb,bf_HAMMING,src_gray)
            est_orb_2,inl = det.detect_match(K,kp_temp_orb_2,des_temp_orb_2,logo_temp_2_shape,orb,bf_HAMMING,src_gray)
            est_orb_5,inl = det.detect_match(K,kp_temp_orb_5,des_temp_orb_5,logo_temp_5_shape,orb,bf_HAMMING,src_gray)
            est_orb_10,inl = det.detect_match(K,kp_temp_orb_10,des_temp_orb_10,logo_temp_10_shape,orb,bf_HAMMING,src_gray)
...
def dump(output_dir,hdf5_data,ep):
        ...
        output_hdf5_path = output_dir + '/T265_alt_DBSCAN_8repr_clust_solve_naive_timing_matches' + '.hdf5'
        ...
        hdf5_file.close()
dump(current_dir,hdf5_data,'T265_alt_DBSCAN_8repr_clust_solve_naive_timing_matches')
