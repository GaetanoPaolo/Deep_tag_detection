...
import detect_match_opt as det
...
def pose_est(kp_temp_orb_1, des_temp_orb_1,kp_temp_orb_2, des_temp_orb_2,
    ...
    if rel_pos_c[2] < 3.0:
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                thread_1= executor.submit(det.detect_match,K,kp_temp_orb_1,des_temp_orb_1,logo_temp_1_shape,kp_target,des_target,bf_HAMMING,src_gray)
                thread_2= executor.submit(det.detect_match,K,kp_temp_orb_2,des_temp_orb_2,logo_temp_2_shape,kp_target,des_target,bf_HAMMING,src_gray)
                thread_5 = executor.submit(det.detect_match,K,kp_temp_orb_5,des_temp_orb_5,logo_temp_5_shape,kp_target,des_target,bf_HAMMING,src_gray)
                thread_10 = executor.submit(det.detect_match,K,kp_temp_orb_10,des_temp_orb_10,logo_temp_10_shape,kp_target,des_target,bf_HAMMING,src_gray)
                est_orb_1 = thread_1.result()
                est_orb_2 = thread_2.result()
                est_orb_5 = thread_5.result()
                est_orb_10= thread_10.result()
            est_orb_lst = [est_orb_1[0],est_orb_2[0],est_orb_5[0],est_orb_10[0]]
...
for ep in range(1,2):
    ...
    for observed_pos in range(160,161):
        ...
        #             "detect_parallel_pose_est_below_3m.dat")
        # start = time.time()
...
#         output_hdf5_path = output_dir + '/T265_alt_DBSCAN_8repr_clust_solve_naive_timing_detect_parrallel' + '.hdf5'
...
#             )
#         hdf5_file.close()
# dump(current_dir,hdf5_data,'T265_alt_DBSCAN_8repr_clust_solve_naive_timing_detect_parrallel')
