...
import detect_match_opt_cuda_total as det
...
orb = cv.cuda.ORB_create(2000,1.1,8,21,0,2,0,21,20)
...
def pose_est(kp_temp_orb_2, des_temp_orb_2,
    ...
    if rel_pos_c[2] < 3.0:
            ...
            #     trans = zerarr
            # else:
            #     idx = inlier_am_lst.index(min(inlier_am_lst))
...
for ep in range(1,2):
    ...
    for observed_pos in range(160,161):
        ...
        #             "cuda_total_pose_est_below_3m_160.dat")
        start = time.time()
...
#         output_hdf5_path = output_dir + '/T265_alt_DBSCAN_profile_total_cv_cuda_FAST_5_30inl' + '.hdf5'
...
#             )
#         hdf5_file.close()
# dump(current_dir,hdf5_data,'T265_alt_DBSCAN_profile_total_cv_cuda_FAST_5_30inl')
