...
for ep in range(1,3):
    ...
    #for observed_pos in range(136,137):
...
def dump(output_dir,hdf5_data,ep):
        ...
        output_hdf5_path = output_dir + 'multi_eval_T265_threshold_step_resolution_cuda_match' + '.hdf5'
        ...
        hdf5_file.close()
dump(current_dir,hdf5_data,'multi_eval_T265_threshold_step_resolution_cuda_match')
